...
angular.module('app', ['ngAnimate', 'ngSanitize', 'ngCookies', 'ui.router', 'entity.controllers', 'entity.services', 'entity.filters', 'entity.directives','search.services', 'search.directives', 'alert.services'])
